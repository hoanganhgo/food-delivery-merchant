...
public class OrderWaitShipperActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_wait_shipper);

        lnOrder = findViewById(R.id.ln_order_wait_shipper);
